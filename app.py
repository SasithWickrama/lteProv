...
from lynked.lynked import Lynked
from urlshort.urlshort import Shorturl
...
class ShortUrl(Resource):
    def get(self):
        data = request.get_json()
        return Shorturl.short_url(data)

#Lynked Requests
class Create(Resource):
    def post(self):
        data = request.get_json()
        return  Lynked.create(data)
...
# URL SHORT
api.add_resource(ShortUrl, '/api/url/shorturl/')

# LYNKED
api.add_resource(Create, '/api/lynked/create/')
